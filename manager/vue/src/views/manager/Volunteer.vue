  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="avatar" label="个人照片">
          <template v-slot="scope">
            <el-image v-if="scope.row.avatar" style="width: 50px" :src="scope.row.avatar" :preview-src-list="[scope.row.avatar]"></el-image>
          </template>
        </el-table-column>
    ...
    <el-dialog title="安保人员信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="介绍" prop="info">
          <el-input type="textarea" v-model="form.info" placeholder="介绍"></el-input>
        </el-form-item>
