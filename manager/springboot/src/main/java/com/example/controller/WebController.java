...
import com.example.common.enums.ValidateCodeProperties;
...
public class WebController {
    ...
    public Result getCount(){
        ...
        Dict dict = Dict.create().set("helpCount", helps.size()).set("volCount", volunteers.size()).set("donateCount", donates.size()).set("commentCount", comments.size());
    ...
    public Result barData(){
        ...
        for(String type:typeList){
            long count=helpList.stream().filter(donate -> donate.getType().equals(type)).count();
            Dict dict=Dict.create().set("name",type).set("value",count);
            list.add(dict);
        }
        return Result.success(list);
